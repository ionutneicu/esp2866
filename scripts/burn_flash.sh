...
sudo python ${ESPTOOL_PATH}/esptool.py --port /dev/ttyUSB0  write_flash 0x00000 ../../esp8266_bin/eagle.flash.bin
sudo python ${ESPTOOL_PATH}/esptool.py --port /dev/ttyUSB0  write_flash 0x20000 ../../esp8266_bin/eagle.irom0text.bin
